...
const WalkMission = ({ SecondModalClosingFunction, ThirdModalClosingFunction }) => {
    const [StepCounterScreenVisibility, SetStepCounterScreenVisibility] = useState(false)
    const ToggleStepCounterModal = () => {
        SetStepCounterScreenVisibility(!StepCounterScreenVisibility)
    }
    ...
    return (
        ...
        <View style={styles.missionReadyBackground}>
            <View style={styles.container}>
                ...
                <TouchableOpacity
                    style={styles.button}
                    onPress={ToggleStepCounterModal}
                >
            ...
            <Modal
                animationType='slide'
                transparent={false}
                visible={StepCounterScreenVisibility}
            >
                <StepCounter
                    ModalClosingFunction={ToggleStepCounterModal}
                    SecondModalClosingFunction={SecondModalClosingFunction}
